 ...
 * @returns {Promise}
 */
ImageMagick.prototype.getTitle = function (image) {
 ...
 * @returns {Promise}
 */
ImageMagick.prototype.getDescription = function (image) {
  return new Promise(function (resolve, reject) {
 ...
 * @returns {Promise}
 */
ImageMagick.prototype.getKeywords = function (image) {
  return new Promise(function (resolve, reject) {
 ...
 * @returns {Promise}
 */
ImageMagick.prototype.getCategory = function (image) {
  return new Promise(function (resolve, reject) {
 ...
 * @returns {Promise}
 */
ImageMagick.prototype.getFormat = function (image) {
  return new Promise(function (resolve, reject) {
 ...
 * @returns {Promise}
 */
ImageMagick.prototype.iptc = function (image) {
  return Promise.all([
    this.getTitle(image),
 ...
 * @returns {Promise}
 */
ImageMagick.prototype.resize = function (image, _config) {
  var config = _config || {};
 ...
 * @returns {Promise}
 */
ImageMagick.prototype.crop = function (image, _config) {
  var config = _config || {};
 ...
 * @returns {Promise}
 */
ImageMagick.prototype.thumbnail = this.resize;
